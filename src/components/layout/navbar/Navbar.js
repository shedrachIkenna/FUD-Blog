        ...
        <div className="navbar">
            <div className="flex md:flex-col h-full md:h-screen justify-between p-3 md:p-0 ">
                <div className="flex flex-row md:flex-col md:justify-between">
                    ...
                    <h1 className="border-b font-bold text-2xl md:py-8 text-center md:text-left md:px-4 md:text-3xl">FUD-Blog</h1>
                            ...
                            <div className="md:px-2 border-b py-2 md:py-8"> 
                                ...
                                <div className="flex">
                                    <NavLink to="/" className="navlink flex items-center">
                                        ...
                                        <span className="pl-2 text-lg md:text-xl md:pl-6">Notification</span>
                                    </NavLink>
                                </div>
                            </div>
                            <div className="border-b md:px-2 py-2 md:py-8">
                                <div className="mb-2 md:m-0">
                                    <NavLink to="/" className="md:text-xl">Settings</NavLink>
                                </div>
                                <div className="mb-2 md:m-0 md:pt-6">
                                    <NavLink to="/" className="md:text-xl">Privacy</NavLink>
                                </div>
                                <div className="mb-2 md:m-0 md:pt-6">
                                    <NavLink to="/" className="md:text-xl">Explore</NavLink>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex flew-row justify-between md:flex-col md:items-center md:pb-6">
                    <div className="pr-1 md:pt-6">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9 " fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                    </div>
                    <div className="pr-1 relative md:pt-10">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-9" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                        </svg>
